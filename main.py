...
bot = telebot.TeleBot('5972071887:AAFd5IiEpPNvvCJoIhv_aFLMohpG9qp4ywI')
...
def get_user_text(message):
    if message.text == "Кандайсын":
        ...
        bot.send_message(message.chat.id, "мен баардык суроого жооп бере албайм)", parse_mode='html')
